...
from PyQt5.QtCore import Qt, QIODevice, QBuffer, QObject
from PyQt5.QtGui import QIcon, QImage, QPainter, QPainterPath, QPen, QResizeEvent
from PyQt5.QtWidgets import QTextEdit, QSizePolicy, QMainWindow, QAction, QApplication, QToolBar
...
class MainWindow(QtWidgets.QMainWindow, QtGui.QWindow):
    ...
    def __init__(self):
        ...
        super(QtGui.QWindow,self).__init__()
